...
int ClosedFileByName(char *name)
{
	int i=0;
...
int main()
{
	...
	while(1)
	{
		...
		if(count==1)
		{
			...
			{
				printf("Terminating teh marvellous Virtual File System\n");
				break;
			}
			else
			{
		...
		else if(count == 2)
		{
			...
			/*	else if(strcmp(command[0],"close")==0)
				...
				else if(strcmp(command[0],"write")==0)
				{
				   ...
				   if(ret==-3)
				      printf("ERROR:it is no regular file file\n");
				}
